...
{
	if (region.ak.O === region.au.O)
	{
		return 'on line ' + region.ak.O;
	}
	return 'on lines ' + region.ak.O + ' through ' + region.au.O;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aw: fragment, ay: host, aI: path, aL: port_, aO: protocol, aP: query};
	});
...
var $author$project$Main$NewBoids = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$Boid = F5(
	function (x, y, vx, vy, biasVal) {
		return {y: biasVal, a: vx, e: vy, h: x, i: y};
	});
...
var $author$project$Main$generateBoid = F2(
	function (h, w) {
		var y = A2($elm$random$Random$float, 0, h);
		var x = A2($elm$random$Random$float, 0, w);
		var vy = A2($elm$random$Random$float, -1, 1);
		var vx = A2($elm$random$Random$float, -1, 1);
		var bias = A2($elm$random$Random$float, 0, 0);
		return A6($elm$random$Random$map5, $author$project$Main$Boid, x, y, vx, vy, bias);
	});
...
var $author$project$Main$generateBoids = F3(
	function (h, w, n) {
		return A2(
			$elm$random$Random$list,
			n,
			A2($author$project$Main$generateBoid, h, w));
	});
var $author$project$Main$nBoids = 100;
var $elm$core$Basics$round = _Basics_round;
var $author$project$Main$init = function (_v0) {
	var width = _v0.E;
	var height = _v0.A;
	return _Utils_Tuple2(
		{G: _List_Nil, A: height, E: width},
		A2(
			$elm$random$Random$generate,
			$author$project$Main$NewBoids,
			A3(
				$author$project$Main$generateBoids,
				$elm$core$Basics$round(height),
				$elm$core$Basics$round(width),
				$author$project$Main$nBoids)));
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {ag: oldTime, aS: request, aX: subs};
	});
...
var $author$project$Main$biasIncrement = 0.004;
var $author$project$Main$maxBias = 0.05;
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $author$project$Main$updateBias = F2(
	function (direction, boid) {
		var biasVal2 = A2($elm$core$Basics$max, $author$project$Main$biasIncrement, boid.y - $author$project$Main$biasIncrement);
		var biasVal1 = A2($elm$core$Basics$min, boid.y + $author$project$Main$biasIncrement, $author$project$Main$maxBias);
		if (!direction) {
			return (boid.a < 0) ? _Utils_update(
				boid,
				{y: biasVal1, a: ((1 - biasVal1) * boid.a) + biasVal1}) : _Utils_update(
				boid,
				{y: biasVal1, a: ((1 - biasVal2) * boid.a) + biasVal2});
		} else {
			return (boid.a < 0) ? _Utils_update(
				boid,
				{y: biasVal1, a: ((1 - biasVal1) * boid.a) - biasVal1}) : _Utils_update(
...
var $author$project$Main$matchingFactor = 0.05;
var $elm$core$Basics$pow = _Basics_pow;
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $author$project$Main$distance = F2(
	function (boid1, boid2) {
		return $elm$core$Basics$sqrt(
			A2($elm$core$Basics$pow, boid1.h - boid2.h, 2) + A2($elm$core$Basics$pow, boid1.i - boid2.i, 2));
	});
var $author$project$Main$visibleRange = 40;
var $author$project$Main$updateAlignmentP = F3(
	function (boid, boid2, _v0) {
		var nNeighbors = _v0.a;
		var avgvx = _v0.b;
		var avgvy = _v0.c;
		return (_Utils_cmp(
			A2($author$project$Main$distance, boid, boid2),
			$author$project$Main$visibleRange) < 0) ? _Utils_Tuple3(nNeighbors + 1, avgvx + boid2.a, avgvy + boid2.e) : _Utils_Tuple3(nNeighbors, avgvx, avgvy);
	});
var $author$project$Main$updateAlignment = F2(
	function (boids, boid) {
		var _v0 = A3(
			$elm$core$List$foldl,
			$author$project$Main$updateAlignmentP(boid),
			_Utils_Tuple3(0, 0, 0),
			boids);
		var n = _v0.a;
		var avgvx_ = _v0.b;
		...
		var avgvx = avgvx_ / n;
		var avgvy = avgvy_ / n;
		return (!n) ? boid : _Utils_update(
			boid,
			{a: boid.a + ($author$project$Main$matchingFactor * (avgvx - boid.a)), e: boid.e + ($author$project$Main$matchingFactor * (avgvy - boid.e))});
	});
var $author$project$Main$centeringFactor = 0.0001;
var $author$project$Main$updateCohesionP = F3(
	function (boid, boid2, _v0) {
		var nNeighbors = _v0.a;
		var avgx = _v0.b;
		var avgy = _v0.c;
		return (_Utils_cmp(
			A2($author$project$Main$distance, boid, boid2),
			$author$project$Main$visibleRange) < 0) ? _Utils_Tuple3(nNeighbors + 1, avgx + boid2.h, avgy + boid2.i) : _Utils_Tuple3(nNeighbors, avgx, avgy);
	});
var $author$project$Main$updateCohesion = F2(
	function (boids, boid) {
		var _v0 = A3(
			$elm$core$List$foldl,
			$author$project$Main$updateCohesionP(boid),
			_Utils_Tuple3(0, 0, 0),
			boids);
		var n = _v0.a;
		var avgx_ = _v0.b;
		...
		return (!n) ? boid : _Utils_update(
			boid,
			{a: boid.a + ($author$project$Main$centeringFactor * (avgx - boid.h)), e: boid.e + ($author$project$Main$centeringFactor * (avgy - boid.i))});
	});
var $author$project$Main$updatePosition = function (boid) {
	return _Utils_update(
		boid,
		{h: boid.h + boid.a, i: boid.i + boid.e});
};
var $author$project$Main$avoidFactor = 0.05;
var $author$project$Main$protectedRange = 8;
var $author$project$Main$updateSeperationP = F3(
	function (boid, boid2, _v0) {
		var closevx = _v0.a;
		var closevy = _v0.b;
		return (_Utils_cmp(
			A2($author$project$Main$distance, boid, boid2),
			$author$project$Main$protectedRange) < 0) ? _Utils_Tuple2((closevx + boid.h) - boid2.h, (closevy + boid.i) - boid2.i) : _Utils_Tuple2(closevx, closevy);
	});
var $author$project$Main$updateSeperation = F2(
	function (boids, boid) {
		var _v0 = A3(
			$elm$core$List$foldl,
			$author$project$Main$updateSeperationP(boid),
			_Utils_Tuple2(0, 0),
			boids);
		var closevx = _v0.a;
		var closevy = _v0.b;
		return _Utils_update(
			boid,
			{h: boid.h + ($author$project$Main$avoidFactor * closevx), i: boid.i + ($author$project$Main$avoidFactor * closevy)});
	});
var $author$project$Main$maxSpeed = 8;
var $author$project$Main$minSpeed = 1;
var $author$project$Main$updateSpeed = function (boid) {
	var speed = $elm$core$Basics$sqrt(
		A2($elm$core$Basics$pow, boid.a, 2) + A2($elm$core$Basics$pow, boid.e, 2));
	if (_Utils_cmp(speed, $author$project$Main$maxSpeed) > 0) {
		var vy = (boid.e / speed) * $author$project$Main$maxSpeed;
		var vx = (boid.a / speed) * $author$project$Main$maxSpeed;
		return _Utils_update(
			boid,
			{a: vx, e: vy});
	} else {
		if (_Utils_cmp(speed, $author$project$Main$minSpeed) < 0) {
			var vy = (boid.e / speed) * $author$project$Main$minSpeed;
			var vx = (boid.a / speed) * $author$project$Main$minSpeed;
			return _Utils_update(
				boid,
				{a: vx, e: vy});
		} else {
...
var $author$project$Main$turnFactor = 0.1;
var $author$project$Main$updateTurn = F3(
	function (boid, windowHeight, windowWidth) {
		var topmargin = 0.1 * windowHeight;
		var rightmargin = 0.9 * windowWidth;
		var leftmargin = 0.1 * windowWidth;
		var vx = (_Utils_cmp(boid.h, leftmargin) < 0) ? (boid.a + $author$project$Main$turnFactor) : ((_Utils_cmp(boid.h, rightmargin) > 0) ? (boid.a - $author$project$Main$turnFactor) : boid.a);
		var bottommargin = 0.9 * windowHeight;
		var vy = (_Utils_cmp(boid.i, topmargin) < 0) ? (boid.e + $author$project$Main$turnFactor) : ((_Utils_cmp(boid.i, bottommargin) > 0) ? (boid.e - $author$project$Main$turnFactor) : boid.e);
		return _Utils_update(
			boid,
			{a: vx, e: vy});
	});
var $author$project$Main$updateBoid = F4(
	function (windowHeight, windowWidth, boids, boid) {
		var boid1 = A2($author$project$Main$updateSeperation, boids, boid);
		var boid2 = A2($author$project$Main$updateAlignment, boids, boid1);
		var boid3 = A2($author$project$Main$updateCohesion, boids, boid2);
		var boid4 = A3($author$project$Main$updateTurn, boid3, windowHeight, windowWidth);
		var boid5 = $author$project$Main$updateSpeed(boid4);
		var boid8 = $author$project$Main$updatePosition(boid5);
		return boid8;
	});
var $author$project$Main$updateBoids = F3(
	function (windowHeight, windowWidth, boids) {
		var boidsMiddle = A2(
			$elm$core$List$drop,
			10,
			A2(
				$elm$core$List$take,
				$elm$core$List$length(boids) - 10,
				boids));
		var boidsLast = $elm$core$List$reverse(
			A2(
				$elm$core$List$map,
				$author$project$Main$updateBias(1),
				A2(
					$elm$core$List$take,
					10,
					$elm$core$List$reverse(boids))));
		var boidsFirst = A2(
			$elm$core$List$map,
			$author$project$Main$updateBias(0),
			A2($elm$core$List$take, 10, boids));
		var boidsFinal = _Utils_ap(
			boidsFirst,
			_Utils_ap(boidsMiddle, boidsLast));
		var boids1 = A2(
			$elm$core$List$map,
			A3($author$project$Main$updateBoid, windowHeight, windowWidth, boids),
			boidsFinal);
		return boids1;
	});
var $author$project$Main$update = F2(
	function (msg, context) {
		if (!msg.$) {
			var newBoids = A3($author$project$Main$updateBoids, context.A / 2, context.E / 2, context.G);
			return _Utils_Tuple2(
				_Utils_update(
					context,
					{G: newBoids}),
...
var $author$project$Main$drawBoid = function (boid) {
	var angle = A2($elm$core$Basics$atan2, boid.e, boid.a);
	return A2(
...
var $joakin$elm_canvas$Canvas$renderTextFill = F5(
	function (txt, x, y, maybeColor, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$fillText, txt.aZ, x, y, txt.ae),
			function () {
				if (!maybeColor.$) {
					var color = maybeColor.a;
					return A2(
...
var $joakin$elm_canvas$Canvas$renderTextStroke = F5(
	function (txt, x, y, maybeColor, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$strokeText, txt.aZ, x, y, txt.ae),
			function () {
				if (!maybeColor.$) {
					var color = maybeColor.a;
					return A2(
	...
	function (x, y, t, cmds) {
		return A2(
			...
			function () {
				if (!t.$) {
					var image = t.a;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, 0, 0, image.E, image.A, x, y, image.E, image.A, image.V);
				} else {
					var sprite = t.a;
					var image = t.b;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, sprite.h, sprite.i, sprite.E, sprite.A, x, y, sprite.E, sprite.A, image.V);
				}
			}(),
			cmds);
	});
				...
				function (tagName, width, height) {
					return (tagName === 'IMG') ? $elm$core$Maybe$Just(
						$joakin$elm_canvas$Canvas$Internal$Texture$TImage(
							{A: height, V: image, E: width})) : $elm$core$Maybe$Nothing;
				}),
	...
	function (options, attrs, entities) {
		return A3(
			...
			A2(
				...
				A2(
					$elm$core$List$cons,
					$elm$html$Html$Attributes$height(options.A),
					A2(
						$elm$core$List$cons,
						$elm$html$Html$Attributes$width(options.E),
						attrs))),
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2('__canvas', $joakin$elm_canvas$Canvas$cnvs),
				A2($elm$core$List$map, $joakin$elm_canvas$Canvas$renderTextureSource, options.a_)));
	});
...
var $author$project$Main$view = function (_v0) {
	...
	return A3(
		...
		A2(
			...
			A2($elm$core$List$map, $author$project$Main$drawBoid, boids)));
};
